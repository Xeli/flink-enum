...
final class AvroFactory<T> {
	...
	private static <T> AvroFactory<T> fromSpecific(Class<T> type, ClassLoader cl, Optional<Schema> previousSchema) {
        ...
        specificData.addLogicalTypeConversion(new org.apache.avro.data.TimeConversions.DateConversion());
        specificData.addLogicalTypeConversion(new org.apache.avro.Conversions.DecimalConversion());
